...
func Connect_databases() {
	...
	var err error
	db, err = gorm.Open("mysql", "root:Xcy3329257@(localhost)/db_common?charset=utf8mb4&parseTime=True&loc=Local")
	if err != nil {
		fmt.Println("数据库连接成功")
		panic(err)
	}
